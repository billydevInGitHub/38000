...
insert into appl_diagram_rect (  DT_Application_Name,        Job_Id, x,  y,   width, height, x_job_name, y_job_name ) 
                        values( "data_88010_U001_Diagram_c", 67,      568,185, 25,    25,     580,        230); 
insert into appl_diagram_rect (  DT_Application_Name,        Job_Id, x,  y,   width, height, x_job_name, y_job_name ) 
                        values( "data_88010_U001_Diagram_c", 66,      488,185, 25,    25,     500,        230); 
insert into appl_diagram_rect (  DT_Application_Name,        Job_Id, x,  y,   width, height, x_job_name, y_job_name ) 
                        values( "data_88010_U001_Diagram_c", 65,      408,185, 25,    25,     420,        230); 
insert into appl_diagram_rect (  DT_Application_Name,        Job_Id, x,  y,   width, height, x_job_name, y_job_name ) 
                        values( "data_88010_U001_Diagram_c", 69,      528,345, 25,    25,     540,        390); 
insert into appl_diagram_rect (  DT_Application_Name,        Job_Id, x,  y,   width, height, x_job_name, y_job_name ) 
                        values( "data_88010_U001_Diagram_c", 64,      488,25, 25,    25,      500,        70); 
insert into appl_diagram_rect (  DT_Application_Name,        Job_Id, x,  y,   width, height, x_job_name, y_job_name ) 
                        values( "data_88010_U001_Diagram_c", 68,      408,345, 25,    25,     420,        390); 
insert into appl_diagram_rect (  DT_Application_Name,        Job_Id, x,  y,   width, height, x_job_name, y_job_name ) 
                        values( "data_88010_U001_Diagram_c", 70,      488,505, 25,    25,     500,        550);                                                                                                                         
